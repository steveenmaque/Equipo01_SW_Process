...
public class XmlGeneratorService {
     ...
     * @param datosFactura Datos adicionales de la factura (forma pago, detracción, etc.)
    ...
    public String generarXMLFactura(Cotizacion cotizacion, DatosFacturaElectronica datosFactura) throws Exception {
        ...
        if (datosFactura.montoDetraccion > 0) {
            ...
            agregarElemento(doc, detraccion, "cbc:PaymentPercent", String.format("%.2f", datosFactura.porcentajeDetraccion));
