...
public class InfleSusVentasApplication {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("✓ Contexto de Spring Boot iniciado");
        ...
        SwingUtilities.invokeLater(() -> {
            try {
                ...
                System.out.println("✓ Look and Feel del sistema establecido");
                ...
                // MODIFICADO: Crear y mostrar ventana principal (pasar context)
                MainWindow mainWindow = new MainWindow(controller, context);
